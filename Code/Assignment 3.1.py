# -*- coding: utf-8 -*-
"""
Created on Thu Dec 19 13:10:50 2024
...
# Random Forest Classifier trainen
...
# Voorspellingen en accuraatheid
y_pred = model.predict(X_test)
print("B_Accuracy:", metrics.balanced_accuracy_score(y_test, y_pred))
