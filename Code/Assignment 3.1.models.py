...
tabel = PrettyTable()
tabel.field_names = ["Type of model", "Accuracy", "Balanced accuracy", "Precision", "Recall"]
...
def models(X_train, X_test, y_train, y_test):
    ...
    dump_model(clf, "support vector classifier")
...
def data_augmentation_with_fingerprints(n_variants):
...
X_train, X_test, y_train, y_test = data_augmentation_with_fingerprints(1)
...
# Laad het model
trained_model = joblib.load("randomforest model")
